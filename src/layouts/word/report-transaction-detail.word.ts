...
export async function generateReportTransactionDetail(
  dataWord: TableData<TransactionDetailModel>[],
  companyName,
  companyAddress,
  companyCode,
  title,
          ...
          new Table({
            ...
            rows: [
              new TableRow({
                ...
                children: TRANSACTION_DETAIL_COLUMNS.map((item) => {
