import {
  FONT_NAME,
  ORDER_TRANSFER_INCOMPLETED_COLUMNS,
  WORD_FILE_CONFIG,
} from '@utils/constant';
import {
  AlignmentType,
...
export async function generatereportOrderTransferIncompleted(
  dataWord,
  companyName,
  companyAddress,
  title,
          ...
          new Table({
            ...
            rows: [
              new TableRow({
                ...
                children: ORDER_TRANSFER_INCOMPLETED_COLUMNS.map((item) => {
