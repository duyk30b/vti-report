...
echo WAREHOUSE_YARD_SERVICE_PORT=$WAREHOUSE_YARD_SERVICE_PORT >> .env
echo WAREHOUSE_YARD_SERVICE_HOST=$WAREHOUSE_YARD_SERVICE_HOST >> .env
...
echo PLAN_SERVICE_PORT=$PLAN_SERVICE_PORT >> .env
echo PLAN_SERVICE_HOST=$PLAN_SERVICE_HOST >> .env

echo MMS_SERVICE_HOST=$MMS_SERVICE_HOST >> .env
echo MMS_SERVICE_PORT=$MMS_SERVICE_PORT >> .env
